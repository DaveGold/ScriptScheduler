...
let PIWebAPIService = class PIWebAPIService {
    ...
    getPIPointDataByPath(fullPath) {
        return __awaiter(this, void 0, void 0, function* () {
            const pointResponse = yield this.pointAPI.pointGetByPath(fullPath);
            const valueResponse = yield this.streamAPI.streamGetValue(pointResponse.body.WebId);
    ...
    getEventFramesForElement(elementWebId) {
        return __awaiter(this, void 0, void 0, function* () {
            const eventFrameResponse = yield this.elementAPI.elementGetEventFrames(elementWebId);
            return eventFrameResponse.body;
        });
    }
    createEventFrameForElement(databasePath, elementWebId) {
        return __awaiter(this, void 0, void 0, function* () {
            const eventFrame = new piwebapi_1.EventFrame();

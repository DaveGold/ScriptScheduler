...
function runAgenda() {
    return __awaiter(this, void 0, void 0, function () {
        var dbConnectionString, agenda;
        return __generator(this, function (_a) {
            console.log(PeriodicJobs);
            dbConnectionString = "mongodb://localhost:27017/scriptScheduler";
            agenda = new Agenda({ db: { address: dbConnectionString, collection: "jobs" } });
            // Define a "job", an arbitrary function that agenda can execute
            agenda.define("hello", function () {
